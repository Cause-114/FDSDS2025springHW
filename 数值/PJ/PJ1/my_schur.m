...
% function [Q, H,cnt] = upper_iter(Q, H)
    ...
    % figure;
    % plot(num_converge(1:cnt+1));
    % title(sprintf('Number of converge with size of matrix %d', n));
    % xlabel('Iteration');
    % ylabel('Number of converge');
